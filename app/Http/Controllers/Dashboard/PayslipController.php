...
class PayslipController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($staff_data as $val) {
            ...
            // $paye = 0;
            // if ($tax_before_relief < round($tax_before_relief)) {
            $paye = (int) $tax_before_relief - $personal_relief;
            // }
            //
            //total_deductions
            ...
            // array_push($results, round($tax_before_relief) > (int) $period->paye_lower_limit);
            ...
            $payroll->gross_salary = $user_payroll_info['gross_salary'];
            ...
            // array_unshift($results, new PayrollResource($payroll));
        }
